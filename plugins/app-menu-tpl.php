<div class="menu-options icon-background no-submenu-numbers sidebar-menu">
   ...
   <a class="close-sidebar" onclick="alert('No content')" href="#departments-tpl_main"><i class="icon-bg bg-green-dark ion-ios-paper-outline"></i><span>departments</span><i class="ion-record"></i></a>
   <a class="close-sidebar" onclick="alert('No content')" href="#new-examination-tpl_main"><i class="icon-bg bg-red-dark ion-ios-heart"></i><span>new examination</span><i class="ion-record"></i></a>
   <a class="close-sidebar" onclick="alert('No content')" href="#my-examinations-tpl_main"><i class="icon-bg bg-night-dark ion-checkmark"></i><span>my examinations</span><i class="ion-record"></i></a>
   <?php if(!$user->logged()){?>

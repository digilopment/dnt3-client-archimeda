      ...
      <div class="sidebars sidebars-light">
         <div class="sidebar sidebar-left">
            ...
            <div class="menu-options icon-background no-submenu-numbers sidebar-menu">
               ...
               <a href="#departments-tpl_main"><i class="icon-bg bg-green-dark ion-ios-paper-outline"></i><span>departments</span><i class="ion-record"></i></a>
               <a href="#new-examination-tpl_main"><i class="icon-bg bg-red-dark ion-ios-heart"></i><span>new examination</span><i class="ion-record"></i></a>
               <a href="#my-examinations-tpl_main"><i class="icon-bg bg-night-dark ion-checkmark"></i><span>my examinations</span><i class="ion-record"></i></a>
               <a href="#login-form_main"><i class="icon-bg bg-night-dark ion-log-in"></i><span>login</span><i class="ion-record"></i></a>
               <a href="#registration-form_main"><i class="icon-bg bg-night-dark ion-ios-star"></i><span>registration</span><i class="ion-record"></i></a>

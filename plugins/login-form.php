...
<div class="page-login content">
    <form class="" id="<?php echo $selector; ?>" action="" novalidate="novalidate">
        ...
        <div class="page-login-input full-bottom">
            ...
            <input type="password" name="pass" value="" placeholder="<?php echo $multiLanguage->translate($data, "password", "translate"); ?>">
        </div>
        ...
        <?php } ?>
        <button type="submit" name="login" class="button button-green button-icon button-full half-top full-bottom"/><i class="ion-log-in"></i><?php echo $multiLanguage->translate($data, "login_to_account", "translate"); ?></button>

        <div class="pageapp-login-links">
            <a href="#" class="page-login-forgot "><i class="ion-eye"></i><?php echo $multiLanguage->translate($data, "forgot_credentials", "translate"); ?></a>
            <a href="#registration-form_main" class="page-login-create "><?php echo $multiLanguage->translate($data, "create_account", "translate"); ?><i class="ion-person"></i></a>
            <div class="clear"></div>
        </div>
    </form>
</div>

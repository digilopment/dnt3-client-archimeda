...
<div class="page-login content">
    <form class="" id="<?php echo $selector; ?>" action="" novalidate="novalidate">
        ...
        <div class="page-login-input">
            ...
            <input name="name" type="text" placeholder="<?php echo $multiLanguage->translate($data, "name", "translate"); ?>" value="" >
        </div>
        <div class="page-login-input">
            <i class="login-icon ion-person"></i>
            <input name="surname" type="text" placeholder="<?php echo $multiLanguage->translate($data, "surname", "translate"); ?>" value="" >
        </div>
        <div class="page-login-input">
            <i class="login-icon ion-at"></i>
            <input type="text" name="email" placeholder="<?php echo $multiLanguage->translate($data, "email_addr", "translate"); ?>">
        </div>
        <div class="page-login-input full-bottom">
            <i class="login-icon ion-locked"></i>
            <input type="password" name="password" placeholder="<?php echo $multiLanguage->translate($data, "password", "translate"); ?>">
        </div>
...
<?php } ?>
        <button type="submit" name="sent" class="button button-green button-icon button-full half-top full-bottom"/><i class="ion-log-in"></i><?php echo $multiLanguage->translate($data, "create_account", "translate"); ?></button>
        <div class="pageapp-login-links">
            <a href="#login-form_main" class="page-login-create "><?php echo $multiLanguage->translate($data, "have_account", "translate"); ?><i class="ion-person"></i></a>
            <div class="clear"></div>
        </div>
    </form>
</div>
    ...
    jQuery(document).ready(function () {
        jQuery("#<?php echo $selector; ?>").validate({
            ...
            messages: {
                ...
                surname: "<?php echo $multiLanguage->translate($data, "required_field", "translate"); ?>",
                email: "<?php echo $multiLanguage->translate($data, "required_field", "translate"); ?>é",
                password: "<?php echo $multiLanguage->translate($data, "required_field", "translate"); ?>",
